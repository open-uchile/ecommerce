require(["jquery", "eol_pages/basket_page"], function ($, BasketPage) {
  "use strict";
  ...
  $(document).ready(function () {
    ...
    if (
      window.courseKey !== undefined &&
      !window.location.href.split("discount_jwt=")[1]
    ) {
      $.ajax({
        ...
        if (discount.discount_applicable) {
          ...
          if (indexOfFragment > -1) {
            newUrl =
              oldUrl.substring(0, indexOfFragment) +
              discountString +
